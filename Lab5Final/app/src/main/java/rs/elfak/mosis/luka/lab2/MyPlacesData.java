...
public class MyPlacesData {
    ...
    private MyPlacesData(){
        ...
        database = FirebaseDatabase.getInstance("https://lab5-934de-default-rtdb.firebaseio.com/").getReference();
    ...
    public void updatePlace(int index, String nme, String description, String lng, String lat){
